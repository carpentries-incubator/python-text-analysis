...
## The Perceptron 
![Single artificial neuron](files/images/wordEmbed_NN-perceptron.svg)
...
![Linear Decision Boundary](files/images/wordEmbed_NN-cats-dogs-linear-boundary.png)
...
![Multilayer neural network](files/images/wordEmbed_NN-MLP.svg)
...
![Hierarchical Feature Representations - Face Detection](files/images/wordEmbed_NN-hierarchical-features.png)
...
![Skipgram](files/images/wordEmbed_NN-training-methods.png)
...
![Word2Vec Model Architecture (Skip-gram)](files/images/wordEmbed_NN-SG-model-architecture.png)
...
![Image from Word2Vec research paper, by Mikolov et al](files/images/wordEmbed_NN-training-methods.png)
